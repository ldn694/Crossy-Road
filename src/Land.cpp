...
Land::Land(Context context, const TextureHolder& textures, SoundPlayer& sounds, Difficulty difficulty, int variant) : Road(toTextureID(static_cast<Land::Variant>(variant)), textures, Road::Type::Land, Zone::Safety::Safe, difficulty){
